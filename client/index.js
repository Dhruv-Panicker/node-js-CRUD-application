...
document.querySelector('table tbody').addEventListener('click', function(event) {
    ...
    if(event.target.dataset.className === "edit-row-btn") {
...
function deleteRowById(id) {
    //Sending call to the backend for item to be deleted
...
addBtn.onclick = function() {
    ...
    //Reset the name input each time you make a request to the backend
...
function insertRowIntoTable(data) {
    ...
    //Check if this class does exist
    const isTableData = table.querySelector('.no-data');

    let tableHtml = "<tr>";

    //Looping through the object that is returned 
    for (var key in data) {
